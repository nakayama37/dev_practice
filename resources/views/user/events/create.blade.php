                ...
                <div class="p-6 text-gray-900">
                  ...
                  <!-- エラーメッセージ -->
                   <x-error-message/>
                    ...
                    <form method="POST" action="{{ route('user.events.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="md:flex justify-between items-end">
                          <div class="mt-4">
                            ...
                            <x-text-input id="max_people"  class="block mt-1 w-full" type="number" name="max_people" :value="old('max_people')" required min="1"/>
                          </div>

                          <div class="mt-4">
                            <x-input-label for="price" value="価格（円）" />
                            <x-text-input id="price"  class="block mt-1 w-full" type="number" name="price" min="0" :value="old('price')" />
                          </div>
