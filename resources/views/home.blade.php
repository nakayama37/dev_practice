          ...
          <div class="bg-white border-1 border border-gray-200 rounded-lg overflow-hidden mb-4">
            ...
            <div class="p-4">
              ...
              <div class="flex justify-between items-center mt-4">
                <span class="text-2xl font-extrabold text-gray-900">{{ $event->formatted_price == 0 ? '無料' : $event->formatted_price . '円' }}</span>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="overflow-x-scroll scrollbar-hide mb-4 relative px-0.5" style="overflow-y: hidden;">
          ...
          @endif   
              ...
              <span class="t❤ext-gray-400 inline-flex items-center leading-none text-sm">
                <svg class="w-4 h-4 mr-1" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                  <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"></path>
                </svg>{{ $event->comment_count !== null ? $event->comment_count : '0' }}
              </span>
