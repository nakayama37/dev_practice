<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <h2 class="text-center mt-4">予約済みのイベント一覧</h2>
                                        ...
                                        @foreach ($fromTodayEvents as $event)
                                            <tr>
                                                <td class="text-blue-500 px-4 py-3"><a
                                                        href="{{ route('mypage.show', ['id' => $event['id']]) }}">{{ $event['title'] }}</a>
                                                </td>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <h2 class="text-center mt-4">いいねをしたイベント一覧</h2>
                <div class="p-4 text-gray-900">
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-4 mx-auto">
                                    ...
                                    <tbody>
                                        @foreach ($likedEvents as $event)
                                            <tr>
                                                ...
                                                @else
                                                    <td class="text-blue-500 px-4 py-3"><a
                                                            href="{{ route('reservations.detail', ['event' => $event->id]) }}">{{ $event->title }}</a>
                                                    </td>
                                                @endif
                                                <td class="px-4 py-3">{{ $event->start_at }}</td>
                                                <td class="px-4 py-3">{{ $event->end_at }}</td>
                                                <td class="px-4 py-3">{{ $event->total_participants }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <h2 class="text-center mt-4">過去のイベント一覧</h2>
                <div class="p-4 text-gray-900">
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 py-4 mx-auto">
